...
Labels, spelled-out counts, and the caption's shape clauses live in
``results_top_behaviors_wording``.
"""
...
from src.appendix.results_top_behaviors_wording import (TOP_K, _shape_note, axis_label,
                                                        count_word)
