...
A prompted Phase-0 organism from a separate project (anonymized for review). An open-weight model is given a covert
...
`script/external`, and the run and verdict land under `out/main/external/idt_organism/`.
