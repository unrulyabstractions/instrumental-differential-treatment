...
| `src/organisms` | vendored external organisms audited by the pipeline |
...
`configs/secret_loyalties/calibration_targets.json` pairs each calibration checkpoint with the
