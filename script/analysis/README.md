...
| `judge_seat_agreement.py` | Measures how far two judge seats agree verdict by verdict on identical responses. Reports raw agreement, Cohen's kappa, each seat's firing rate, and the correlation of the cell rates the test reads. | `uv run python script/analysis/judge_seat_agreement.py --a out/r2/score/calibration_informed/verdicts_base_1p5b.jsonl --b out/r2_nano/score/calibration_informed/verdicts_base_1p5b.jsonl` |
